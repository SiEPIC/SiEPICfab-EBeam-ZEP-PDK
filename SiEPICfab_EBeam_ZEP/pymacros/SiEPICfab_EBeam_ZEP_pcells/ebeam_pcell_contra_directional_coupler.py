...
class ebeam_pcell_contra_directional_coupler(pya.PCellDeclarationHelper):

    def __init__(self):
        # Important: initialize the super class
        super(ebeam_pcell_contra_directional_coupler, self).__init__()
        ...
        self.param("grating_period", self.TypeDouble,
                   "Grating period (microns)", default=0.32)
        ...
        self.param("rib", self.TypeBoolean, "Use rib (ridge) waveguides?", default=True, hidden=True)
        self.param("layer_rib", self.TypeLayer, "Cladding Layer",
                   default=TECHNOLOGY['Si_clad'])
        ...
        self.param("l_heater", self.TypeLayer, "Heater Layer", default=TECHNOLOGY['M1'])
        self.param("l_metal", self.TypeLayer, "Metal contact Layer", default=TECHNOLOGY['M1'])
    ...
    def display_text_impl(self):
        ...
        return "ebeam_pcell_contra_directional_coupler_%sN-%.1fnm period" % \
...
#          print("x: %s, y: %s" % (x1,y1))
        ...
        if self.rib == False:
            ...
            region_devrec2 = Region(DevRecBox).size(2500)
            shapes_rib += shapes_wg
            shapeRib = shapes_rib.size(2000) - shapes_wg - (region_devrec2-region_devrec)
