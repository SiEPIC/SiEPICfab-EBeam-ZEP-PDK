...
class ZEP_PWB_surface_taper(pya.PCellDeclarationHelper):
  """
  ...
  def __init__(self):
    ...
    super(ZEP_PWB_surface_taper, self).__init__()
  ...
  def produce(self, layout, layers, parameters, cell):
    ...
    if self.show_deepTrench:
        ...
        pts5 = [Point(0, excl/dbu),Point((offset+l+excl)/dbu,excl/dbu),Point((offset+l+excl)/dbu,-excl/dbu),Point(0,-excl/dbu)]
        ...
        pts5 = [Point(-(excl+l+150)/dbu, excl/dbu),Point((offset+l+excl)/dbu,excl/dbu),Point((offset+l+excl)/dbu,-excl/dbu),Point(-(excl+l+150)/dbu,-excl/dbu)]
    '''
    pts5 = [Point(-(excl+l+150)/dbu, excl/dbu),Point((offset+l+excl)/dbu,excl/dbu),Point((offset+l+excl)/dbu,-excl/dbu),Point(-(excl+l+150)/dbu,-excl/dbu)]
    #draw the taper
    ...
    Lw2 = 15
    pts7 = [Point((offset+l)/dbu, (w2/2)),Point((offset+l+Lw2)/dbu,(w2/2)),Point((offset+l+Lw2)/dbu,(-w2/2)),Point((offset+l)/dbu,(-w2/2))]
    
    #place waveguide section
    shapes(LayerSiN).insert(Polygon(pts7))

    #draw alignment marker
    pts1 = [Point((0+offset)/dbu,12.4/dbu),Point((0+offset)/dbu,9/dbu),Point((3.5+offset)/dbu,9/dbu),Point((3.5+offset)/dbu,12.5/dbu),Point((0.1+offset)/dbu,12.5/dbu),Point((0+offset)/dbu,12.6/dbu),Point((0+offset)/dbu,16/dbu),Point((-3.5+offset)/dbu,16/dbu),Point((-3.5+offset)/dbu,12.5/dbu),Point((-0.1+offset)/dbu,12.5/dbu)]
    
    pts2 = [Point((0+50+offset)/dbu,12.4/dbu),Point((0+50+offset)/dbu,9/dbu),Point((3.5+50+offset)/dbu,9/dbu),Point((3.5+50+offset)/dbu,12.5/dbu),Point((0.1+50+offset)/dbu,12.5/dbu),Point((0+50+offset)/dbu,12.6/dbu),Point((0+50+offset)/dbu,16/dbu),Point((-3.5+50+offset)/dbu,16/dbu),Point((-3.5+50+offset)/dbu,12.5/dbu),Point((-0.1+50+offset)/dbu,12.5/dbu)]
    ...
    pts3 = [Point(OxOp_DT_gap/dbu,y_oxop/dbu),Point((offset+l+10+dx-1)/dbu,y_oxop/dbu),Point((offset+l+10+dx-1)/dbu,dy_oxop/dbu),Point((offset+l+10-dx-1)/dbu,-dy_oxop/dbu),Point((offset+l+10-dx-1)/dbu,-(y_oxop-10)/dbu),Point(OxOp_DT_gap/dbu,-(y_oxop-10)/dbu)]

    #place oxide open window
    shapes(LayerOxOpN).insert(Polygon(pts3))

    #draw devrec box
    pts4 = [Point(0,y_oxop/dbu),Point((offset+l+10+dx)/dbu,y_oxop/dbu),Point((offset+l+10+dx)/dbu,-(y_oxop-10)/dbu),Point(0,-(y_oxop-10)/dbu)]
    ...
    text = Text("ZEP_PWB_surface_taper_Shangxuan",t)
    shape = shapes(LayerTEXTN).insert(text) 
    shape.text_size = 7/dbu
...
'''
  def display_text_impl(self):
    ...
    if self.show_deepTrench:
        return "PWB_taper (tip_width=" + ('%.2f' % self.Wtip) + ",waveguide_width=" + ('%.2f' % self.Wwaveguide) + ",taper_length=" + ('%.1f' % self.taper_length) + ",Angle=" + ('%s' % self.OxOp_angle) + ",edge_offset=" + ('%.2f' %self.edge_offset) + ")"
    else:
